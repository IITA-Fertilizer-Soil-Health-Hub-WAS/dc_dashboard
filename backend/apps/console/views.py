...
SETUP_CARD_META: dict[str, tuple[str, str, str]] = {
    ...
    "event-schedule": ("Visit schedule", "event",
    ...
    "rejection-reasons": ("Decline reasons", "block",
    ...
    "plot-election": ("Choose plots", "where_to_vote",
                     "Review proposed plots and choose the trial plots."),
