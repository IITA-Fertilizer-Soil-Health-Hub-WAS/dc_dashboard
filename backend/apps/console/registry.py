...
_ENTRIES: list[Managed] = [
    ...
    Managed("event-schedule", EventScheduleItem, "Visit schedule", "Configuration",
    ...
    Managed("rejection-reasons", RejectionReason, "Decline reasons", "Operations",
    ...
    Managed("memberships", Membership, "Project access", "Accounts & roles",
    ...
    Managed("user-profiles", UserProfile, "Identity profiles", "Accounts & roles",
    ...
    Managed("collector-accounts", CollectorAccount, "Collector accounts", "Accounts & roles",
