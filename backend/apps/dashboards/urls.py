...
urlpatterns = [
    ...
    path("project/<slug:code>/", views.usecase_detail, name="usecase"),
    ...
    path("project/<slug:code>/tab/review/action/", views.tab_review_action, name="tab_review_action"),
    path("project/<slug:code>/qc-signoff/", views.qc_signoff, name="qc_signoff"),
    path("project/<slug:code>/household/<uuid:hh_id>/", views.household_timeline, name="household_timeline"),
    path("project/<slug:code>/tab/enumerators/", views.tab_enumerators, name="tab_enumerators"),
    path("project/<slug:code>/tab/issues/", views.tab_issues, name="tab_issues"),
    path("project/<slug:code>/tab/data/", views.tab_data, name="tab_data"),
    path("project/<slug:code>/tab/final/", views.tab_final, name="tab_final"),
    path("project/<slug:code>/final.csv", views.export_final, name="export_final"),
    path(
        "project/<slug:code>/submission/<uuid:submission_id>/review/",
        views.submission_review,
        name="submission_review",
    ),
    path(
        "project/<slug:code>/submission/<uuid:submission_id>/media/<str:name>/",
        views.submission_media,
        name="submission_media",
    ),
    path("project/<slug:code>/bulk-action/", views.bulk_submission_action, name="bulk_action"),
    path(
        "project/<slug:code>/submission/<uuid:submission_id>/action/",
