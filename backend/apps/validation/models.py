...
class ValidationRule(BaseModel):
    ...
    class RuleType(models.TextChoices):
        ...
        CROSS_FIELD = "CROSS_FIELD", "Cross-column check (sum/relation)"
        CONDITIONAL_REQ = "CONDITIONAL_REQ", "Conditionally required field"
        UNIQUE_FIELD = "UNIQUE_FIELD", "Unique field (duplicate detection)"
        MEDIA_REQUIRED = "MEDIA_REQUIRED", "Required attachment / photo"
        REFERENCE_MATCH = "REFERENCE_MATCH", "Sample id in reference dataset"
        REFERENCE_COMPARE = "REFERENCE_COMPARE", "Cross-check vs reference (lab) value"
        ...
        NUMERIC_OUTLIER = "NUMERIC_OUTLIER", "Numeric statistical outlier (z-score / IQR)"
