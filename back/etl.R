...
# Appending validation and NOT data together for upload to azure storage as one file for Solidaridad.
...
NOTSol1 <- as.data.frame(NOTSol1) %>% flatten_list_columns()
valSol1 <- as.data.frame(valSol1) %>% flatten_list_columns()

upload_to_azure(NOTValSol2, "SolidaridadSUMdata.csv", cont)
upload_to_azure(valSol1, "SolidaridadOdata.csv", cont)
upload_to_azure(NOTSol1, "SolidaridadNOTdata.csv", cont)
